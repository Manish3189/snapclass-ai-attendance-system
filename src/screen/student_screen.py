...
from src.database.db import get_all_students,create_student,get_student_subjects,get_student_attendance,unenrolled_student_to_subject
import time
...
def student_dashboard():
    ...
    c1,c2 = st.columns(2)
    with c1:
        st.header("Your Enrolled Sujects")
    with c2:
    ...
    for i ,sub_node in enumerate(subjects):
        ...
        def unenroll_btn():
            if st.button("Unenroll From course" , type='tertiary',width='stretch'):
                unenrolled_student_to_subject(student_id,sid)
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name" ,placeholder= "Mohan")
            ...
            audio_data = None
            try:
                audio_data = st.audio_input('Record a short phrase like I am Present, My Name is Mohan.')
            except Exception:
                    ...
                    with st.spinner('Creating Profile..'):
                        ...
                        if encodings:
                            ...
                            if response_data:
                                ...
                                st.error("Couldn't capture your facial feature for the registor ! Try again")
